...
header = """/* C:/Users/az-su/Documents/databased/final-project/load_musicbrainz.sql */""" + "\n" +\
...
with open('load_musicbrainz.sql', 'w') as outfile:
    ...
    for fname in filenames:
        ...
        line2 = "'s3://cs327e-final-project-datasets/music-brainz-csv/" + noPath +"'" + "\n"
